...
// Write a function processProducts that uses map() to create a new array of product names, 
// and then uses forEach() to log each product name along with a message indicating whether the price is above or below $50.
